...
public class PhonePwdLoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(MResource.getIdByName(PhonePwdLoginActivity.this, "layout", "tencent_tls_ui_activity_phone_pwd_login"));
        ...
        if ((login_way & Constants.QQ_LOGIN) != 0) { // QQ登录
            tlsService.initQQLoginService(this,
                    (Button) findViewById(MResource.getIdByName(PhonePwdLoginActivity.this, "id", "btn_qqlogin")));
        }

        if ((login_way & Constants.WX_LOGIN) != 0) { // 微信登录
            tlsService.initWXLoginService(this,
                    (Button) findViewById(MResource.getIdByName(PhonePwdLoginActivity.this, "id", "btn_wxlogin")));
        }
    ...
    private void initPhonePwdService() {
        tlsService.initPhonePwdLoginService(this,
                (EditText) findViewById(MResource.getIdByName(PhonePwdLoginActivity.this, "id", "selectCountryCode")),
                (EditText) findViewById(MResource.getIdByName(PhonePwdLoginActivity.this, "id", "phone")),
                (EditText) findViewById(MResource.getIdByName(PhonePwdLoginActivity.this, "id", "password")),
                (Button) findViewById(MResource.getIdByName(PhonePwdLoginActivity.this, "id", "btn_login"))
        );

        // 设置点击"注册新用户"事件
        findViewById(MResource.getIdByName(PhonePwdLoginActivity.this, "id", "registerNewUser"))
        ...
        // 设置点击"重置密码"事件
        findViewById(MResource.getIdByName(PhonePwdLoginActivity.this, "id", "resetPassword"))
                .setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
    ...
    public void setPassword(final int type) {
        ...
        View view = layoutInflater.inflate(MResource.getIdByName(PhonePwdLoginActivity.this, "layout", "tencent_tls_ui_dialog"), null);

        final EditText editText = (EditText)view.findViewById(MResource.getIdByName(PhonePwdLoginActivity.this, "id", "password"));
        Button btn_confirm = (Button)view.findViewById(MResource.getIdByName(PhonePwdLoginActivity.this, "id", "btn_confirm"));
        Button btn_cancel = (Button)view.findViewById(MResource.getIdByName(PhonePwdLoginActivity.this, "id", "btn_cancel"));
                ...
                if (type == 1) { // 设置密码
                    tlsService.TLSPwdRegCommit(regPassword, new TLSPwdRegListener() {
                        ...
                        public void OnPwdRegCommitSuccess(TLSUserInfo userInfo) {
                            ...
                            ((EditText) findViewById(MResource.getIdByName(PhonePwdLoginActivity.this, "id", "selectCountryCode"))).setText(countryCode);
                            ((EditText) findViewById(MResource.getIdByName(PhonePwdLoginActivity.this, "id", "phone"))).setText(phoneNumber);
                            ((EditText) findViewById(MResource.getIdByName(PhonePwdLoginActivity.this, "id", "password"))).setText(regPassword);

                            findViewById(MResource.getIdByName(PhonePwdLoginActivity.this, "id", "btn_login")).performClick();
                        }
