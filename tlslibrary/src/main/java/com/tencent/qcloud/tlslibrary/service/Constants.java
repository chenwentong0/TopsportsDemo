...
//    public final static String EXTRA_THIRDAPP_CLASS_NAME_SUCC = "com.tencent.tls.THIRDAPP_CLASS_NAME_SUCC";
    ...
    public static String thirdappPackageNameSucc = TlsBusiness.getContext().getPackageName();
    public static String thirdappClassNameSucc = "com.example.chenwentong.helloworld.MainActivity";
    // TODO: 2018/8/24 登录失败回调页面
