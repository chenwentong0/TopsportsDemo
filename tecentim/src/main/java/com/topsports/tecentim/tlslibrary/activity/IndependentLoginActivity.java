...
public class IndependentLoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((login_way & Constants.QQ_LOGIN) != 0) { // QQ登录
            tlsService.initQQLoginService(this,
                    (Button) findViewById(MResource.getIdByName(this, "id", "btn_qqlogin")));
        }

        if ((login_way & Constants.WX_LOGIN) != 0) { // 微信登录
            tlsService.initWXLoginService(this,
                    (Button) findViewById(MResource.getIdByName(this, "id", "btn_wxlogin")));
        }
            ...
            public void run() {
                ...
                if (userInfo != null) {
                    EditText editText = (EditText) IndependentLoginActivity.this
                            .findViewById(MResource.getIdByName(IndependentLoginActivity.this, "id", "username"));
    ...
    private void initAccountLoginService() {
        tlsService.initAccountLoginService(this,
                ...
                (Button) findViewById(MResource.getIdByName(this, "id", "btn_login")));

        // 设置点击"注册新用户"事件
        findViewById(MResource.getIdByName(this, "id", "registerNewUser"))
        ...
        // 手机短信登录
        findViewById(MResource.getIdByName(this, "id", "hostLogin"))
                .setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
...
//        initTLSLogin();
    ...
    protected void onResume() {
        ...
        if (username != null && password != null) {
            ((EditText) findViewById(MResource.getIdByName(this, "id", "username"))).setText(username);
            ((EditText) findViewById(MResource.getIdByName(this, "id", "password"))).setText(password);
            findViewById(MResource.getIdByName(this, "id", "btn_login")).performClick();
        }
    }
}
