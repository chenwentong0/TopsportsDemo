...
import com.topsports.tecentim.utils.TimeUtil;
...
public abstract class Message {
     ...
     */
    public abstract void showMessage(ChatViewHolder viewHolder, Context context);
     ...
     * @param viewHolder 界面样式
     */
    public RelativeLayout getBubbleView(ChatViewHolder viewHolder){
     ...
     * @param viewHolder 界面样式
     */
    public void showStatus(ChatViewHolder viewHolder){
     ...
     *
     */
    protected void clearView(ChatViewHolder viewHolder){
     ...
     *
     */
    boolean checkRevoke(ChatViewHolder viewHolder) {
        if (message.status() == TIMMessageStatus.HasRevoked) {
            viewHolder.leftPanel.setVisibility(View.GONE);
            viewHolder.rightPanel.setVisibility(View.GONE);
    ...
    private void showDesc(ChatViewHolder viewHolder){
