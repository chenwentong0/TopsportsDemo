...
public class VoiceMessage extends Message {
    ...
    public void showMessage(ChatViewHolder viewHolder, Context context) {
        ...
        LinearLayout linearLayout = new LinearLayout(InitBusiness.getContext());
        linearLayout.setOrientation(LinearLayout.HORIZONTAL);
        linearLayout.setGravity(Gravity.CENTER);
        ImageView voiceIcon = new ImageView(InitBusiness.getContext());
        ...
        TextView tv = new TextView(InitBusiness.getContext());
        tv.setTextSize(TypedValue.COMPLEX_UNIT_SP, 18);
        tv.setTextColor(ContextCompat.getColor(InitBusiness.getContext(), isSelf() ? R.color.white : R.color.black));
    ...
    public String getSummary() {
        ...
        return InitBusiness.getContext().getString(R.string.summary_voice);
    }
