package com.example.common.utils.imageutil.config;
...
import com.example.common.utils.imageutil.glide.ImgLoaderUtil;
...
public class SingleConfig {
    ...
    public static class ConfigBuilder {
        ...
        public ConfigBuilder override(int oWidth, int oHeight) {
            this.oWidth = ScreenUtil.dp2px(oWidth);
            this.oHeight = ScreenUtil.dp2px(oHeight);
            return this;
        }
        ...
        public ConfigBuilder rectRoundCorner(int rectRoundRadius) {
            this.rectRoundRadius = ScreenUtil.dp2px(rectRoundRadius);
