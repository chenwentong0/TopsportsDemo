 ...
 * 好友关系链管理逻辑
 */
public class FriendshipManagerPresenter extends BaseIMPresenter<IBaseView> {
    ...
    public FriendshipManagerPresenter(FriendshipMessageView view, LifecycleProvider lifecycleProvider){
        this(view, null, null, lifecycleProvider);
    }

    public FriendshipManagerPresenter(FriendInfoView view, LifecycleProvider lifecycleProvider){
        this(null, null, view, lifecycleProvider);
    }

    public FriendshipManagerPresenter(FriendshipManageView view, LifecycleProvider lifecycleProvider){
        this(null, view, null, lifecycleProvider);
    }

    public FriendshipManagerPresenter(FriendshipMessageView view1, FriendshipManageView view2, FriendInfoView view3, LifecycleProvider lifecycleProvider){
        super(null, lifecycleProvider);
