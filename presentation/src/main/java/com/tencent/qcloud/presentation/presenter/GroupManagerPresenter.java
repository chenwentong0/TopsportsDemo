 ...
 * 群管理逻辑
 */
public class GroupManagerPresenter extends BaseIMPresenter<IBaseView> {
    ...
    public GroupManagerPresenter(GroupManageMessageView view, LifecycleProvider lifecycleProvider){
        this(view, null, null, lifecycleProvider);
    }

    public GroupManagerPresenter(GroupInfoView view, LifecycleProvider lifecycleProvider){
        this(null, view, null, lifecycleProvider);
    }

    public GroupManagerPresenter(GroupManageView view, LifecycleProvider lifecycleProvider){
        this(null, null, view, lifecycleProvider);
    }

    public GroupManagerPresenter(GroupManageMessageView view1, GroupInfoView view2, GroupManageView view3, LifecycleProvider lifecycleProvider){
